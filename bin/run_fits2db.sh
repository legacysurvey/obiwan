...
db_table=${1}
fits_table=${2}
remotedb=nerscdb03.nersc.gov
echo db_table=$db_table
echo fits_table=$fits_table
#Make table

/global/cscratch1/sd/kaylanb/test/fits2db/fits2db_cori --sql=postgres --create --noload -C -X -t ${db_table} ${fits_table}| /usr/bin/psql -U desi_admin -d desi -h ${remotedb}
...
/global/cscratch1/sd/kaylanb/test/fits2db/fits2db_cori --sql=postgres -C -X -t ${db_table} ${fits_table}| /usr/bin/psql -U desi_admin -d desi -h ${remotedb}
